...
```
/save [--type session|learnings|context|all] [--summarize] [--checkpoint] [--issue NUMBER]
```
...
- **Memory Operations**: Session context storage, checkpoint creation, and discovery archival with `xxx.local.md` suffix
- **Naming Pattern**: `YYYYMMDDhhmm_xxx.local.md` for session/plan, `YYYYMMDDhhmm_xxx.md` for learnings, or `issue123_xxx.local.md` when issue specified
...
- **Local File Management**: Session info saved as `YYYYMMDD_session.local.md` or `issue123_session.local.md`, work plans as `YYYYMMDD_plan_TASKNAME.local.md` or `issue123_plan_TASKNAME.local.md` (gitignored), learnings as `YYYYMMDD_learnings.md` (committed)
...
# Session info saved as 202509191000_session.local.md (gitignored)
...
# Session saved as 202509191000_session.local.md or issue456_session.local.md if issue context
...
# Learnings saved as 202509191000_learnings.md (committed to repository)
# Updates project understanding without full session preservation
```

### Issue-Based Session Save

```
/save --issue 123
# Saves session context related to specific issue
# Session saved as issue123_session.local.md (gitignored)
# Work plans saved as issue123_plan_TASKNAME.local.md
```
